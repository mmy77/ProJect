...
class filedialogdemo(QWidget):
    ...
    def loadFile(self):
        print("load--file")
        self.fname, _ = QFileDialog.getOpenFileName(self, 'choose', '/home/lxq/seg_hw/', 'Image files(*.jpg *.gif *.png)')
        pixmap = QPixmap()
    ...
    def compute_pic(self):
        ...
        #image = Image.open(os.path.join(IMAGE_DIR, name))s
...
saver.restore(sess, save_path='/home/lxq/seg_hw/model_deeplabv3+/model.ckpt')
